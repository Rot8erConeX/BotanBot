...
def data_load()
  ...
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLWeapons.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLWeapons.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @weapons=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLSkills.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLSkills.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLFacilities.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLFacilities.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLMaterials.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLMaterials.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @mats=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLEnemies.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLEnemies.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @enemies=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLBanners.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLBanners.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @banners=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLEmotes.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLEmotes.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @npcs=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLStatus.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLStatus.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
  ...
  @statuses=b.map{|q| q}
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLVoid.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLVoid.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
...
def prefixes_save()
  x=@prefixes
  open("C:/Users/#{@mash}/Desktop/devkit/DLPrefix.rb", 'w') { |f|
    f.puts x.to_s.gsub('=>',' => ').gsub(', ',",\n  ").gsub('{',"@prefixes = {\n  ").gsub('}',"\n}")
  }
end

def metadata_load()
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLSave.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLSave.txt").each_line do |line|
      b.push(eval line)
    end
  else
...
def metadata_save()
  ...
  open("C:/Users/#{@mash}/Desktop/devkit/DLSave.txt", 'w') { |f|
    f.puts x[0].to_s
    f.puts x[1].to_s
    f.puts x[2].to_s
    f.puts x[3].to_s
...
def nicknames_load(mode=1)
  if mode==2 && File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLNames2.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLNames.txt").each_line do |line|
      b.push(eval line)
    end
    return b
  elsif File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLNames.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLNames.txt").each_line do |line|
      b.push(eval line)
    end
...
bot.command(:reboot, from: 167657750971547648) do |event| # reboots Botan
  ...
  puts 'DL!reboot'
  exec "cd C:/Users/#{@mash}/Desktop/devkit && BotanBot.rb #{@shardizard}"
end
...
def find_weapon(name,event,fullname=false,ext=false)
  ...
  unless ext
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[2][0,1]}*#{q[3]}#{q[1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[2][0,1]}#{q[3]}#{q[1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[2][0,1]}*#{q[1]}#{q[3]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[2][0,1]}#{q[1]}#{q[3]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[3]}#{q[2][0,1]}*#{q[1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[3]}#{q[2][0,1]}#{q[1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[1]}#{q[2][0,1]}*#{q[3]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[1]}#{q[2][0,1]}#{q[3]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[3]}#{q[1]}#{q[2][0,1]}*".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[3]}#{q[1]}#{q[2][0,1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[1]}#{q[3]}#{q[2][0,1]}*".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
    k=@weapons.find_index{|q| !['p','s','v'].include?(q[2][1,1]) && q[3]!='None' && "#{q[1]}#{q[3]}#{q[2][0,1]}".downcase==name.gsub('fire','flame').gsub('dark','shadow').gsub('spear','lance') && q[14]!='FEH'}
    return @weapons[k] unless k.nil?
...
def disp_adventurer_stats(bot,event,args=nil,juststats=false)
  ...
  if !k[12].nil? && k[12]=='FEH'
    ...
    title="#{title}\n**Collab**" unless k[12].nil? || k[12].length<=0
...
def disp_enemy_data(bot,event,args=nil,ignoresub=false)
  ...
  m=false
  IO.copy_stream(open("https://raw.githubusercontent.com/Rot8erConeX/BotanBot/master/FightBanners/Banner_#{xpic}.png"), "C:/Users/#{@mash}/Desktop/devkit/DLTemp#{@shardizard}.png") rescue m=true
...
def disp_gauntlet_data(bot,event,args=nil,name=nil)
  ...
  if File.exist?("C:/Users/#{@mash}/Desktop/devkit/DLGauntlet.txt")
    b=[]
    File.open("C:/Users/#{@mash}/Desktop/devkit/DLGauntlet.txt").each_line do |line|
      b.push(line)
    end
  else
    b=[]
...
def find_in_weapons(bot,event,args=nil,mode=0,allowstr=true,juststats=false)
  ...
  search=[]
  emo=[]
  if rarity.length>0 || tier.length>0 || rarity_tier.length>0
    if rarity.length>0
      search.push("*Rarities*: #{rarity.map{|q| "#{q}#{['','<:Rarity_1:532086056594440231>','<:Rarity_2:532086056254963713>','<:Rarity_3:532086056519204864>','<:Rarity_4:532086056301101067>','<:Rarity_5:532086056737177600>'][q]}"}.join(', ')}")
    ...
    search.push("*Combined Rarity/Tiers*: #{rarity_tier.map{|q| "#{q[0,1]}#{['','<:Rarity_1:532086056594440231>','<:Rarity_2:532086056254963713>','<:Rarity_3:532086056519204864>','<:Rarity_4:532086056301101067>','<:Rarity_5:532086056737177600>'][q[0,1].to_i]}-T#{q[2,1]}"}.join(', ')}") if rarity_tier.length>0
...
def add_new_alias(bot,event,newname=nil,unit=nil,modifier=nil,modifier2=nil,mode=0)
  ...
  if nzzz[nzzz.length-1].length>1 && nzzz[nzzz.length-1][2]>=nzz[nzz.length-1][2]
    ...
    open("C:/Users/#{@mash}/Desktop/devkit/DLNames2.txt", 'w') { |f|
      for i in 0...nzzz.length
        f.puts "#{nzzz[i].to_s}#{"\n" if i<nzzz.length-1}"
      end
    }
...
bot.command([:donation, :donate]) do |event, uid|
  ...
  if uid==167657750971547648
    ...
    if g[2][2]>=3
      ...
      elsif !File.exist?("C:/Users/#{@mash}/Desktop/devkit/EliseImages/#{g[4][2]}.png")
...
bot.command(:snagstats) do |event, f, f2|
  ...
  if ['servers','server','members','member','shard','shards','user','users'].include?(f.downcase)
    ...
    event.channel.send_temporary_message('Calculating data, please wait...',3)
    b=[[],[],[],[],[]]
    File.open("C:/Users/#{@mash}/Desktop/devkit/BotanBot.rb").each_line do |line|
      l=line.gsub("\n",'')
      b[0].push(l)
      b[3].push(l)
      l=line.gsub("\n",'').gsub(' ','')
    ...
    event << "**I am #{longFormattedNumber(File.foreach("C:/Users/#{@mash}/Desktop/devkit/BotanBot.rb").inject(0) {|c, line| c+1})} lines of code long.**"
...
def next_holiday(bot,mode=0)
 ...
 # holidays.push([y8,5,md,'','',"Mother's Day"])
  ...
  if k.length<=0
    ...
    bot.profile.avatar=(File.open("C:/Users/#{@mash}/Desktop/devkit/BotanBot.png",'r')) rescue nil if @shardizard.zero?
    ...
    if k.length==1
      ...
      if t.hour>fcod[0] || (t.hour==fcod[0] && t.min>=fcod[1])
        ...
        if @shardizard.zero?
          bot.profile.avatar=(File.open("C:/Users/#{@mash}/Desktop/devkit/BotanImages/#{k[k.length-1][3]}.png",'r')) rescue nil
        end
        ...
        bot.game=k[j][4]
        if @shardizard.zero?
          bot.profile.avatar=(File.open("C:/Users/#{@mash}/Desktop/devkit/BotanImages/#{k[j][3]}.png",'r')) rescue nil
        end
